        ...
        <div className="min-h-screen bg-background text-foreground">
          ...
          <main>
            ...
            <ServiceSection 
              ...
              services={[
                { title: "Progressive Web Apps", description: "Fast, reliable, and engaging apps that work offline" },
                { title: "Mobile Apps", description: "Native and cross-platform mobile apps for iOS and Android" },
                { title: "Desktop Apps", description: "High-performance desktop apps for Windows, macOS, and Linux" },
            ...
            <ServiceSection 
              ...
              description="Building robust, scalable infrastructure to power your apps"
              services={[
                ...
                { title: "App Migrations", description: "Seamlessly transitioning apps to modern platforms" }
              ]}
              icon="Server"
              reversed={true}
            />
