...
// This file contains sections that were removed from the main landing page
// but preserved for future use

// ===== TRUSTED BY SECTION (previously in Hero.tsx) =====
export const TrustedBySection = () => {
  ...
  return (
    ...
    >
      <p className="text-sm uppercase tracking-wider text-foreground/60 mb-6">{t('hero.trustedBy')}</p>
...
// ===== TEAM SECTION (previously in Team.tsx) =====
export const Team = () => {
  const { t } = useLanguage();
